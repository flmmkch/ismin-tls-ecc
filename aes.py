...
def poly_mult (a, b, mod_pol):
	...
	# This loop reduces the 16-bit-product back to the 8 bits of a GF(2^8) element by the use of the
	# irreducible modulo polynomial of degree 8.
...
def cycle(matrix_in, direction=-1):
...
def inv_cipher(ciphertext, w, inv_s_box, inv_poly_mat):
